...
class TestMysql:
    ...
    def make_match_from_defaults(self, kwargs, match):  # pylint: disable=no-self-use
        ...
        if "read_default_file" not in match:
            match["read_default_file"] = kwargs.get("read_default_file",
    ...
    @pytest.mark.parametrize("kwargs, match", (
        ...
        ({"read_default_file": None}, {"read_default_file": None, "read_default_group": None}),
        ({"read_default_group": "client_test"}, {"read_default_group": "client_test"}),
        ({"host": "labsdb9999"}, {"host": "labsdb9999", "read_default_group": "clientlabsdb"}),
        ({"ssl": {}}, {"ssl": {}}),
        ({"ssl": {1: 3}}, {"ssl": {1: 3}}),
    ))
    ...
    @pytest.mark.parametrize("dry_run, read_only, transaction_ro", (
        (False, False, False),
        (False, True, True),
        (True, False, True),
        (True, True, True),
    ...
    def test_connect_read_only(self, mocked_pymsql_connect,
