...
EQIAD_CORE_MASTERS_QUERY = "db10[01-13]"
CODFW_CORE_MASTERS_QUERY = "db20[01-13]"
...
class TestMysql:
    ...
    def test_get_core_dbs_fail_sanity_check(self):
        ...
        with pytest.raises(mysql.MysqlError, match="Matched 1 masters, expected 13"):
    ...
    def test_set_core_masters_readonly(self, mode, value, caplog):
        ...
        self.mocked_remote.query.return_value = RemoteHosts(self.config, nodeset("db10[01-13]"))
        mock_cumin(self.mocked_transports, 0, retvals=[[("db10[01-13]", value)]])
    ...
    def test_verify_core_masters_readonly_ok(self, readonly, reply, caplog):
        ...
        self.mocked_remote.query.return_value = RemoteHosts(self.config, nodeset("db10[01-13]"))
        mock_cumin(self.mocked_transports, 0, retvals=[[("db10[01-13]", reply)]])
        with caplog.at_level(logging.DEBUG):
    ...
    def test_verify_core_masters_readonly_fail(self):
        ...
        mock_cumin(
            ...
            0,
            retvals=[[("db1001", b"0"), ("db10[02-13]", b"1")]],
        )
        with pytest.raises(
            mysql.MysqlError,
