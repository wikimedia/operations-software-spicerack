...
class TestRedisCluster:
    ...
    def test_start_replica_same_dc(self):
        ...
        with pytest.raises(RedisClusterError, match='Master datacenter must be different from the current datacenter'):
    ...
    def test_stop_replica_fail(self):
        ...
        self.mocked_redis.return_value.info.side_effect = [
            {'role': 'slave', 'master_host': 'host1', 'master_port': 123}] * 3
